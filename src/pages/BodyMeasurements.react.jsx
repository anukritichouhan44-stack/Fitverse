...
//     if (!uid) {
//       console.error("User ID is undefined. Cannot proceed with initialMeasurement.");
//       return;
//     }
//     const data = {
//       weight,
...
//     });
//   } catch (error) {
//     console.error("Error in initialMeasurement:", error);
//   }
// };

// const goalMeasurement = async () => {
//   if (!uid) {
//     console.error("User ID is undefined. Cannot proceed with goalMeasurement.");
//     return;
//   }
...
//     });
//   } catch (error) {
//     console.error("Error in goalMeasurement:", error);
//   }
// };
//   const handleClick = () => {
//     if (
...
const BodyMeasurements = () => {
  ...
  useEffect(() => {
    ...
    console.log("Profile from cookies:", profile);
  ...
  const initialMeasurement = async () => {
    if (!uid) {
      console.error("User ID is undefined. Cannot proceed with initialMeasurement.");
      setStatus("error");
      setMessage("User ID is undefined. Please log in again.");
      navigate("/login"); // Redirect to login page or appropriate page
      return;
    }
